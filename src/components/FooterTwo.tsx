...
const FooterTwo: React.FC = () => {
    return (
        <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70 mt-20">
            ...
            <div className="flex items-center gap-4 mt-8 text-indigo-500">
                <Link to="#" className="hover:-translate-y-0.5 transition-all duration-300">
            ...
            <p className="mt-8 text-center">Copyright © 2025 <a>DocuBrain</a>. All rights reservered.</p>
        </footer>
    )
}
